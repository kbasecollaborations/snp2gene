...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'snp2gene'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from snp2gene.snp2geneImpl import snp2gene  # noqa @IgnorePep8
impl_snp2gene = snp2gene(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'snp2gene'
        ...
        self.rpc_service.add(impl_snp2gene.annotate_gwas_results,
